...
class Course(models.Model):
    ...
    preview = models.ImageField(verbose_name='Предварительный просмотр', upload_to='materials/course', null=True, blank=True)
    description = models.TextField(verbose_name='Описание курса', null=True, blank=True, help_text='Краткое описание курса')
...
class Lesson(models.Model):
    ...
    preview = models.ImageField(verbose_name='Предварительный просмотр', upload_to="materials/lesson", null=True,
                                blank=True)
